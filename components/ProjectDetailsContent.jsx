  ...
  if (!project) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center text-center p-6">
        ...
        <Link
          href="/projects"
          className="underline uppercase tracking-widest font-bold"
        >
          Back to projects
        </Link>
      </div>
          ...
          <div className="w-full lg:w-[45%] order-2 lg:order-1">
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                <span className="text-xs font-bold tracking-[0.4em] text-foreground/50 uppercase">
              ...
              <div className="flex flex-wrap gap-4 mb-12">
                <span className="px-4 py-2 border border-border/40 rounded-full text-xs font-bold uppercase tracking-widest">
                  {project.type}
                </span>
                <span className="px-4 py-2 border border-border/40 rounded-full text-xs font-bold uppercase tracking-widest">
                  {project.year}
              ...
              <div className="space-y-12">
                <div>
                  <h3 className="text-xs font-bold tracking-[0.3em] uppercase text-foreground/40 mb-6">
                    Technologies Used
                  </h3>
                  <div className="flex flex-wrap gap-3">
                    {project.tools.map((tool) => (
                      <span
                        key={tool}
                        className="flex items-center gap-2 text-sm font-bold bg-foreground/5 py-2 px-4 rounded-sm border border-border/10"
                      >
                        <TechIcon
                          name={tool}
